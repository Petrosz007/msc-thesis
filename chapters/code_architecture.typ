...
The Rust compiler can catch a lot of errors during compilation, it's rich typesystem, and lint tools like clippy #footnote[https://github.com/rust-lang/rust-clippy], helps writing correct code. For GPT this was crucial, as there must not be any errors in test case generation.
