...
In their paper, Murane argues that "One disadvantage with boundary value analysis is that it is not as systematic as other prescriptive testing techniques" @murnane2001effectiveness. As I've demonstrated, GPT is systematic and test cases can be generated automatically with my GPT implementation.
...
Last, but not least, I'd like to thank Gyimesi Kristóf for his dedicated support during all four semesters, his great insights when designing complex algorithms, and the massive amount of time he put into proofreading this thesis. #text(fill: white)[t,h,a,n,k,s,,p,e,e,p,s]
