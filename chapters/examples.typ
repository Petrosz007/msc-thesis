...
#todo[
  Write an example implementation for paid vacation days. Show how some (all?) predicate errors can be caught by some test cases generated by GPT.
]

== Equivalence Partitioning vs my GPT in Price Calculation

#todo[@thebook[p. 72] example here with EP and my GPT]
