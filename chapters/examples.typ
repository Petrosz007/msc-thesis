...
== Comparing generated test cases for Paid Vacation Days
...
The comments mark parts of the code with a number. I'll mutate these predicates or expressions and check what test cases fail and catch that there is some error in the implementation.
...
#figure(
  table(
    columns: (auto, auto, auto),
    [No.], [Modified], [Test cases catching it],
    [1], [`let days = 21`], [all],
    [1], [`let days = 23`], [all],
    [2], [`age <= 18`], [\#4, \#10, \#13, \#15],
